...
function PersonalDetailsEntry({ sectionId, sectionTag }) {
    return (
        <div id={sectionTag+"-section"} className="accordion-collapse collapse show" aria-labelledby={sectionId} data-bs-parent="#detail-sections">
